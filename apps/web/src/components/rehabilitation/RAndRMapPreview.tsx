...
interface RAndRMapPreviewProps {
    record: RAndRCase
}

export function RAndRMapPreview({ record }: RAndRMapPreviewProps) {
        ...
        <div className="rounded-xl border border-ink-200 bg-paper p-5 sm:p-6 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-ink-100 pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-ink-900">Geospatial Affected Area Preview</h3>
                        <p className="text-[11px] text-ink-500">PostGIS boundary polygon & centroid coordinates</p>
                    </div>
                </div>
            ...
            <div className="relative h-48 w-full overflow-hidden rounded-lg border border-ink-200 bg-ink-950 flex flex-col items-center justify-center text-paper">
                <div className="absolute inset-0 opacity-20">
                    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <pattern id="rnr-cadastre-grid" width="30" height="30" patternUnits="userSpaceOnUse">
                                <path d="M 30 0 L 0 0 0 30" fill="none" stroke="#ffffff" strokeWidth="0.5" />
                            </pattern>
                        </defs>
                        <rect width="100%" height="100%" fill="url(#rnr-cadastre-grid)" />
                    </svg>
                </div>
            ...
            <div className="flex items-center justify-between text-xs text-ink-600 pt-1 font-mono text-[11px]">
                <span className="flex items-center gap-1">
                    ...
                    <span>Affected Area: {record.affectedAreaHectares} ha</span>
                </span>
