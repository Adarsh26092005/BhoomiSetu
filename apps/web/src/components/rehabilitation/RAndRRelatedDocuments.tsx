...
interface RAndRRelatedDocumentsProps {
    projectId: string
    parcelId?: string
}

export function RAndRRelatedDocuments({ projectId, parcelId }: RAndRRelatedDocumentsProps) {
        ...
        <div className="rounded-xl border border-ink-200 bg-paper p-5 sm:p-6 shadow-xs space-y-4">
            <div className="flex items-center justify-between border-b border-ink-100 pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-ink-900">R&R Scheme Documentation</h3>
                        <p className="text-[11px] text-ink-500">Supporting survey registers, R&R plans, and allotment orders</p>
                    </div>
                </div>
