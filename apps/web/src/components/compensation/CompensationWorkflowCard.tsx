...
interface CompensationWorkflowCardProps {
    projectId: string
}

export function CompensationWorkflowCard({ projectId }: CompensationWorkflowCardProps) {
            ...
            <div className="flex items-center justify-between border-b border-ink-100 pb-3">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-xs font-bold uppercase tracking-wider text-ink-700">
                        Related Statutory Workflow Milestone
                    </h3>
                </div>
