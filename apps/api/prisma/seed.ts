...
async function main() {
  ...
  const districtAuthorityBlr = await prisma.organization.upsert({
    ...
    create: {
      ...
      state: 'Karnataka',
      district: 'Bengaluru',
      parentId: stateAuthorityKarnataka.id,
      isActive: true,
    },
  });
  ...
  const seedUsers = [
    ...
    // Karnataka Regional Officers
    {
      ...
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000022',
      email: 'ka.lao.officer@nlams.gov.in',
      fullName: 'Karnataka Land Acquisition Officer',
      phone: '+91-9800000022',
      role: UserRole.LAND_ACQUISITION_OFFICER,
      designation: 'Special Land Acquisition Officer (Bengaluru CALA)',
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000023',
      email: 'ka.survey.officer@nlams.gov.in',
      fullName: 'Karnataka Cadastral Survey Officer',
      phone: '+91-9800000023',
      role: UserRole.SURVEY_OFFICER,
      designation: 'Assistant Director of Land Records (Bengaluru)',
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000024',
      email: 'ka.revenue.officer@nlams.gov.in',
      fullName: 'Karnataka Revenue Officer (Tahsildar)',
      phone: '+91-9800000024',
      role: UserRole.REVENUE_OFFICER,
      designation: 'Tahsildar (Bengaluru Urban)',
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000025',
      email: 'ka.verification.officer@nlams.gov.in',
      fullName: 'Karnataka Title Verification Officer',
      phone: '+91-9800000025',
      role: UserRole.VERIFICATION_OFFICER,
      designation: 'Scrutiny & Title Verification Officer (Bengaluru)',
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000026',
      email: 'ka.district.officer@nlams.gov.in',
      fullName: 'Karnataka District Officer (DC)',
      phone: '+91-9800000026',
      role: UserRole.DISTRICT_OFFICER,
      designation: 'Deputy Commissioner & District Magistrate (Bengaluru)',
      organizationId: districtAuthorityBlr.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000027',
      email: 'ka.finance.officer@nlams.gov.in',
      fullName: 'Karnataka Finance & Accounts Officer',
      phone: '+91-9800000027',
      role: UserRole.FINANCE_OFFICER,
      designation: 'Treasury & Accounts Officer (Karnataka)',
      organizationId: stateAuthorityKarnataka.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000028',
      email: 'ka.randr.officer@nlams.gov.in',
      fullName: 'Karnataka R&R Administrator',
      phone: '+91-9800000028',
      role: UserRole.R_AND_R_OFFICER,
      designation: 'R&R Commissioner (Karnataka)',
      organizationId: stateAuthorityKarnataka.id,
    },
    {
      id: 'u1000000-0000-4000-a000-000000000029',
      email: 'ka.state.officer@nlams.gov.in',
      fullName: 'Karnataka State Officer',
      phone: '+91-9800000029',
      role: UserRole.STATE_OFFICER,
      designation: 'Principal Secretary (Revenue - Karnataka)',
      organizationId: stateAuthorityKarnataka.id,
    },
  ];
